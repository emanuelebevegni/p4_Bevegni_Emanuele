...
public class Input{
	 ...
	 /*	
	  * Non sapendo come fare l'input/output da riga di comando ho banalmente cercato
	  * soluzione su google ed ho trovato questa classe che ridefinisce i vari metodi
	  *	di lettura da riga di comando.
	 */    
